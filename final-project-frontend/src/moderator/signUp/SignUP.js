        ...
        axios.post('/signup', data)
            .then((res) => {
                if (res.data.validation_errors) {
                    ...
                    setRedirectToLogin(<Redirect from="signup" to="/login"/>)
                }
            })
    };
    ...
    return (
        <div>
            ...
            <form>
                ...
                <input value={userName} onChange={(e)=>srtUserName(e.target.value)} type="text" placeholder="User name"/>
                ...
                <input value={password} onChange={(e)=>setPassword(e.target.value)} type="password"/>
                    ...
                    <select onChange={e => setGender(e.target.value)} defaultValue={'male'} className="form-select">
                    ...
                    <input value={reason} onChange={(e)=>setReason(e.target.value)} type="text"  placeholder="Describe Reason"/>
                    <input type="button" className="btn btn-success my-2" value="Sign Up" onClick={signUpAction}/>
                    </div>
            </form>
            {redirectToLogin}
        </div>
